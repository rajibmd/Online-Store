...
<html>
<head>
	<title>Rajib General Store | Contact </title>
			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">Rajib General Store
							<label style="font-weight: bold;color:black;">Shop No.4 Building No.172/4 Rayer Bazar Dhanmondi, Dhaka-1209</label>
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;"><a style="font-weight: bold;color:black;" href="tel:+8801841012278">+01841012278</a>
						
<!-- 							<label>+(88) 018 410 12278</label> -->
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:mrh201920@gmail.com">mrh201920@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
  ...
  <img src="${pageContext.request.contextPath}/images/loader.gif" alt="loader" style="width: 150px;height: 120px;" id="loader">
	...
	<div class="map mt-sm-0 mt-4">
		<iframe src="https://www.google.com/maps/place/274+Sher-E-Bangla+Rd,+Dhaka+1205/@23.7432243,90.365909,20.17z/data=!4m5!3m4!1s0x3755bf4896fa1ecf:0x973c5974ceedf192!8m2!3d23.7433046!4d90.3661743" allowfullscreen=""></iframe>
	</div>
	<!-- //map -->	
